...
function FirebaseBlogPage({ blog: blogData, user: userData }: { blog: BlogListItem; user?: Partial<UserData> | null }){
  return (
    <div>
      <Head>
...
export default function BlogPage({ blog, user }: { blog: BlogListItem; user?: Partial<UserData> | null }){
